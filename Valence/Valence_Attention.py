...
# Binary classification on valence (1-9 scale); threshold=5: >5 is high valence
...
# data = data.transpose((0, 2, 1))  # Reshape for LSTM: (samples, timesteps, features)
...
#     def build(self, input_shape):
#         self.W = self.add_weight(
#             name="attention_weight", shape=(input_shape[-1], 1), initializer="glorot_uniform", trainable=True
#         )
#         self.b = self.add_weight(
...
#         # Compute the context vector as a weighted sum of the inputs
...
#     Attention(),  # Apply the attention layer
#     Dense(128, activation='relu'),
#     tf.keras.layers.Dropout(0.5),  # Regularization
#     Dense(4, activation='softmax')  # Output layer with softmax activation for classification
# ])
...
# model.save("D:/EEG/src/attention_saved_model.h5")
# print("Attention model saved to D:/EEG/src/attention_saved_model.h5")
